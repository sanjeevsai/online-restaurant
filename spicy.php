		...
		<input type="button" value="LOGOUT" onclick="logout()">	
				...
				<div class="after-nav">
					<br/><br/><br/>
						...
						<h1 align="center"	>STARTERS</h1>
							 ...
							 $data=mysqli_query($link,"select itemname,price,taste,img,name,id from menu where type='starters' order by taste desc");
							...
							?>  " width="300" height="300"> </td><td>	
									...
									<br>TASTE:<input type= "text" value=" <?php echo $row[2]; ?>" name="<?php echo $row[2]; ?>">
									</i>
				...
				<div id="maindishespage"class="maindishes">
						...
						<div ><h1 align="center"	>	MAIN DISHES</h1>
							 ...
							 $data=mysqli_query($link,"select itemname,price,taste,img,name,id from menu where type='main dish' order by taste desc");
								echo"<form action='order.php' method='post'>";
								echo"<table>";
								echo"<tr>";
							$count=1;
	...
	<a href="#" onclick="return false;" onmousedown="goback('head');"><H5 ALIGN="CENTER">TOP</H5></a>
				...
				<h1 align="center"	>ICE CREAMS</h1>
						...
						<?php
							 ...
							 $data=mysqli_query($link,"select itemname,price,taste,img,name,id from menu where type='desert' order by taste desc");
								echo"<form action='order.php' method='post'>";
								echo"<table>";
								echo"<tr>";
							$count=1;
				...
				<div id="juice" class="fruitjuice">
					<h1 align="center">BEVERAGES</h1>
						...
						<?php
							 ...
							 $data=mysqli_query($link,"select itemname,price,taste,img,name,id from menu where type='cool drink' order by taste desc");
								echo"<form action='order.php' method='post'>";	
								echo"<table>";
								echo"<tr>";
							$count=1;
