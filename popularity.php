		...
		<input type="button" value="LOGOUT" onclick="logout()">	
				...
				<div class="after-nav">
					<br/><br/><br/>
						...
						<h1 align="center"	>STARTERS</h1>
							 ...
							 $data=mysqli_query($link,"select itemname,price,popularity,img,name,id from menu where type='starters' order by popularity desc");
							...
							<i>
									...
									POPULARITY<input type= "text" value=" <?php echo $row[2]; ?>" name="<?php echo $row[2]; ?>">
								</i>	
				...
				<div id="maindishespage"class="maindishes">
						...
						<div ><h1 align="center"	>	MAIN DISHES</h1>
							 ...
							 $data=mysqli_query($link,"select itemname,price,popularity,img,name,id from menu where type='main dish' order by popularity");
								echo"<form action='order.php' method='post'>";
								echo"<table>";
								echo"<tr>";
							$count=1;
	...
	<a href="#" onclick="return false;" onmousedown="goback('head');"><H5 ALIGN="CENTER">TOP</H5></a>
				...
				<h1 align="center"	>ICE CREAMS</h1>
						...
						<?php
							 ...
							 $data=mysqli_query($link,"select itemname,price,popularity,img,name,id from menu where type='desert' order by popularity");
								echo"<form action='order.php' method='post'>";
								echo"<table>";
								echo"<tr>";
							$count=1;
							...
							<img src=" <?php echo $row[3]; ?>" width="300" height="300"> </td><td>	
								...
								<i>	ITEM NAME:<input type="text" style="width:300;" value="<?php echo $row[0]; ?>" name=" <?php echo $row[4];?>"><BR>
									ITEM PRICE:<input type= "text" value=" <?php echo $row[1]; ?> RS" name="<?php echo $row[1]; ?>">
									POPULARITY:<input type= "text" value=" <?php echo $row[2]; ?>" name="<?php echo $row[2]; ?>">
								</i>	
									<input type="submit"name="<?php echo $row[5];?>" value="ADD" >
				...
				<div id="juice" class="fruitjuice">
					<h1 align="center">BEVERAGES</h1>
						...
						<?php
							 ...
							 $data=mysqli_query($link,"select itemname,price,popularity,img,name,id from menu where type='cool drink'order by popularity");
								echo"<form action='order.php' method='post'>";	
								echo"<table>";
								echo"<tr>";
							$count=1;
